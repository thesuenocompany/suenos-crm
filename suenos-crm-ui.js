...
const NAV_CFG = {
  admin:[
    ...
    {s:'Insights',items:[{v:'reports',n:'reports',l:'Reports'},{v:'volume-report',n:'reports',l:'Volume Report'},{v:'map',n:'map',l:'Account Map'},{v:'web-analytics',n:'globe',l:'Website'}]},
    ...
    {s:'Setup',   items:[{v:'products',n:'products',l:'Products'},{v:'stores',n:'stores',l:'Stores'},{v:'targets',n:'targets',l:'Targets'},{v:'sales-import',n:'download',l:'Sales Import'},{v:'users',n:'settings',l:'Team'},{v:'regions',n:'pin',l:'Regions'},{v:'licenses-admin',n:'accounts',l:'BC Licences'},{v:'dashboard-email',n:'mail',l:'Email Snapshot'},{v:'licence-prospects',n:'accounts',l:'Prospects'},{v:'outreach',n:'mail',l:'Outreach'},{v:'calls',n:'phone',l:'Voice Calls'}]},
  ],
  rep:[
